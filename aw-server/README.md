...
[![Build Status](https://github.com/pss-tracker/aw-server/workflows/Build/badge.svg?branch=master)](https://github.com/pss-tracker/aw-server/actions?query=workflow%3ABuild+branch%3Amaster)
[![Coverage Status](https://codecov.io/gh/pss-tracker/aw-server/branch/master/graph/badge.svg)](https://codecov.io/gh/pss-tracker/aw-server)


pss-tracker server, for secure storage and retrieval of all your Quantified Self data.

**Note:** In the future this will no longer be the default server used by pss-tracker, instead we will be using [aw-server-rust](https://github.com/pss-tracker/aw-server-rust/). The fate of this repo is uncertain, but it will likely be around and maintained for a while (as a reference implementation, for prototyping, etc).
...
There are also some API examples in the [documentation](https://docs.pss-tracker.net/en/latest/api.html).
