...
div
  ...
  p
    ...
    | You can also find and share categorization rule presets on #[a(href="https://forum.pss-tracker.net/c/projects/category-rules") the forum].
    | For help on how to write categorization rules, see #[a(href="https://docs.pss-tracker.net/en/latest/features/categorization.html") the documentation].
