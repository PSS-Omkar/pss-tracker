...
const browser_appnames = {
  ...
  firefox: [
    ...
    // Pre-releases https://github.com/pss-tracker/aw-watcher-web/issues/87
    'Firefox-esr',
    'Firefox Beta',
    'Nightly',
    'firefox-aurora',
  ...
  edge: [
    ...
    'Microsoft-Edge-Stable', // Arch Linux: https://github.com/pss-tracker/pss-tracker/issues/753
    'Microsoft-edge',
