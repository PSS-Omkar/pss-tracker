...
A web-based UI for pss-tracker, built with Vue.js

[![Build Status](https://github.com/pss-tracker/aw-webui/workflows/Build/badge.svg)](https://github.com/pss-tracker/aw-webui/actions)
[![Coverage Status](https://codecov.io/gh/pss-tracker/aw-webui/branch/master/graph/badge.svg)](https://codecov.io/gh/pss-tracker/aw-webui)
[![Known Vulnerabilities](https://snyk.io/test/github/pss-tracker/aw-webui/badge.svg)](https://snyk.io/test/github/pss-tracker/aw-webui)
...
You may also want to generate fake data so you have something to test with, see: https://github.com/pss-tracker/aw-fakedata/
...
The assets are stored in the following directories (relative to your installation directory), depending on if you use aw-server-python (default) or aw-server-rust:
 ...
 - aw-server-python: `pss-tracker/aw-server/aw_server/static/`
 - aw-server-rust: `pss-tracker/aw-server-rust/static/`
...
configuration file `/pss-tracker/aw-server/aw-server.toml` under respective sections (`server-testing` section when running server in testing mode).
