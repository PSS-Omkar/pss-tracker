...
import pytest
from aw_client import pss-trackerClient
...
@pytest.fixture(scope="session")
def aw_client():
    # TODO: Could it be possible to write a sisterclass of pss-trackerClient
    ...
    c = pss-trackerClient("aw-client-test", testing=True)
    yield c
