...
def get_config_dir(module_name: Optional[str] = None) -> str:
    config_dir = platformdirs.user_config_dir("pss-tracker")
...
def get_log_dir(module_name: Optional[str] = None) -> str:  # pragma: no cover
    ...
    # https://github.com/pss-tracker/aw-core/pull/122#issuecomment-1768020335
    if sys.platform.startswith("linux"):
        log_dir = platformdirs.user_cache_path("pss-tracker") / "log"
    else:
        log_dir = platformdirs.user_log_dir("pss-tracker")
