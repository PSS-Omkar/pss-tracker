...
def get_latest_log_file(name, testing=False) -> Optional[str]:  # pragma: no cover
    ...
    Useful when you want to read the logfile of another pss-tracker service.
    """
...
def _create_file_handler(
    ...
    #  - https://github.com/pss-tracker/pss-tracker/issues/815#issue-1423555466
    #  - https://github.com/pss-tracker/pss-tracker/issues/756#issuecomment-1266662861
