export const window_events = [
  {
    ...
    data: {
      app: 'Firefox',
      title: 'pss-tracker/pss-tracker: Track how you spend your time - Mozilla Firefox',
      url: 'https://github.com/pss-tracker/pss-tracker',
      $category: ['Work', 'Programming', 'pss-tracker'],
    },
  },
  {
    duration: 14.6 * 60,
  ...
  },
  {
    ...
    data: {
      app: 'Terminal',
      title: 'vim ~/code/pss-tracker/aw-server/aw-webui/src',
      $category: ['Work', 'Programming', 'pss-tracker'],
    },
  },
  {
